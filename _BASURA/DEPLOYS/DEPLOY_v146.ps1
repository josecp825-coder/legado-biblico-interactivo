# DEPLOY v146 - LITURGIA ENLACE + SHARE
...
foreach ($f in @('sw.js', 'version.json', 'data_iglesia_v1.js', '_nueva_funcion.js', 'index.html')) {
    try {
...
Write-Host "v146 LITURGIA-ENLACE-SHARE DESPLEGADO"
