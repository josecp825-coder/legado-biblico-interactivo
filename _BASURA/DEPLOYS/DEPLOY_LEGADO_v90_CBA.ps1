# ==========================================
# DESPLIEGUE LEGADO BIBLICO v92 - BOTONES CENTRADOS Y CBA
# Fix: botones LIBRO/CAP/VERSO/CBA siempre visibles y centrados
...
$CORE = @(
    ...
    'data_motor.js', 'cba_motor.js', 'teen-auth.js', 'versus_engine.js',
...
Write-Host "========================================="
Write-Host " LEGADO BIBLICO v92 - BOTONES CENTRADOS"
...
Write-Host ""
Write-Host "========================================="
Write-Host " DESPLIEGUE v92 COMPLETADO"
...
Write-Host "y verifica que los 4 botones se vean completos"
Write-Host ""
