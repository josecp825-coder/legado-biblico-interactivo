# DEPLOY v223 - PENALES VISUAL V3 (v234)
# Nuevo estadio nocturno animado, portero, jugador CSS, sonidos y flujo CONFIRMAR
...
foreach ($f in @('_juego_penal_biblico.js', '_penal_visual.js', 'index.html', 'sw.js', 'version.json')) {
    try {
...
Write-Host 'v223 PENALES-V3 DESPLEGADO'
