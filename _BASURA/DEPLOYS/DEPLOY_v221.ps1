# DEPLOY v221 - PENALES-MENU (v232)
# Tarjeta de Penales Biblicos ahora visible directamente en menu principal de Adolescentes
...
foreach ($f in @('data_teens_v8.js', 'sw.js', 'version.json')) {
    try {
...
Write-Host 'v221 PENALES-MENU DESPLEGADO'
