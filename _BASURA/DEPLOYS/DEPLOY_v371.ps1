# DEPLOY v371 - Fix WhatsApp doble mensaje (solo imagen, sin text duplicado) - 2026-03-23
...
Write-Host "=== DEPLOY v371 - Fix WhatsApp doble mensaje ===" -ForegroundColor Cyan
$ok = 0; $fail = 0
...
Write-Host "v371 DESPLEGADO - WhatsApp solo imagen sin texto duplicado" -ForegroundColor Green
