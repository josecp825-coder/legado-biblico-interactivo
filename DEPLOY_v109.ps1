# DEPLOY v109 - AUTOCOMPLETADO LIBROS BIBLIA EN REGISTRO CULTOS
...
foreach ($f in @('index.html', 'legado.html', 'sw.js', 'version.json', 'data_iglesia_v1.js')) {
    try {
...
Write-Host "v109 DESPLEGADO - Autocompletado Biblia"
