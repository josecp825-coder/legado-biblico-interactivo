# ==========================================
# 🚀 DESPLIEGUE LEGADO BÍBLICO v60
# SOLO archivos de la RAÍZ
# JAMÁS tocar /app/ (Agenda Digital)
# ==========================================

Write-Host ""
Write-Host "========================================" -ForegroundColor Magenta
Write-Host "  LEGADO BIBLICO v60 — DESPLIEGUE" -ForegroundColor White
Write-Host "  30 Historias + Muro Blindado" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Magenta
Write-Host ""
...
# También intentar en /public_html/ por si el hosting lo requiere
Write-Host ""
...
foreach ($archivo in $archivos) {
    ...
    if (Test-Path $fullPath) {
        try {
            ...
            # Silencioso — si falla aquí es porque no existe la carpeta
        }
    }
}
...
Write-Host "  DESPLIEGUE COMPLETADO" -ForegroundColor White
