    ...
    area.innerHTML = `
        ...
        <div style="padding:14px;max-width:800px;margin:0 auto">
            ...
            <div style="text-align:center;margin-bottom:20px">
                ...
                <h2 style="font-size:1.7rem;font-weight:900;margin:0;background:linear-gradient(to right,#55efc4,#a29bfe);-webkit-background-clip:text;-webkit-text-fill-color:transparent">TRIVIA POR LIBRO</h2>
                <p style="opacity:0.35;font-size:0.75rem;margin-top:5px;letter-spacing:2px">ELIGE TU ARENA DE BATALLA BIBLICA</p>
            </div>
            ...
            <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:20px;padding:18px;margin-bottom:14px">
                <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px">
                    ...
                    <div id="libro-badge" style="display:none;margin-left:auto;background:rgba(85,239,196,0.12);border:1px solid #55efc4;color:#55efc4;padding:3px 10px;border-radius:20px;font-size:0.7rem;font-weight:900">OK: <span id="libro-badge-nome"></span></div>
                </div>

                <div style="position:relative;margin-bottom:14px">
                    <input id="filtro-libro-trivia" type="text" placeholder="Busca tu libro..." onkeyup="filtrarLibrosTrivia(this.value)"
                        style="width:100%;background:rgba(0,0,0,0.35);border:1px solid rgba(255,255,255,0.1);padding:12px 16px;border-radius:12px;color:#fff;font-size:0.92rem;box-sizing:border-box;outline:none;font-family:'Outfit',sans-serif"
                ...
                <div style="display:flex;gap:8px;margin-bottom:16px">
                    ${grupos.map((g, i) => `
                        <button onclick="mostrarTestamentoTrivia('${g.nombre}')"
                            ...
                            ${g.nombre === 'ANTIGUO TESTAMENTO' ? 'ANTIGUO T.' : 'NUEVO T.'}
                        </button>
                    `).join('')}
                </div>
                            ...
                            ${Object.entries(g.categorias).map(([cat, libros], ci) => `
                                <div style="margin-bottom:6px">
                                    <div class="cat-header" onclick="toggleCat(this)" style="color:${g.color}">
                                        ...
                                        <span class="cat-arrow" style="opacity:0.35;color:white;font-size:0.8rem">v</span>
                                    </div>
            ...
            <div id="config-avanzada" style="display:none;animation:fadeIn 0.4s ease">
                ...
                <div style="background:rgba(162,155,254,0.06);border:1px solid rgba(162,155,254,0.2);border-radius:20px;padding:18px;margin-bottom:12px">
                    <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px">
                        ...
                        <span style="font-weight:900;font-size:0.88rem;letter-spacing:1px">RANGO DE CAPITULOS</span>
                    ...
                    <div style="display:flex;align-items:center;gap:14px;flex-wrap:wrap">
                        ...
                        <div style="opacity:0.25;font-size:1rem;margin-top:18px">-></div>
                        <div style="display:flex;flex-direction:column;gap:4px;align-items:center">
            ...
            <div style="text-align:center;margin-top:12px">
                <button onclick="renderJuegoTeens()" style="background:none;border:none;color:rgba(255,255,255,0.3);cursor:pointer;font-size:0.82rem;font-family:'Outfit',sans-serif">Volver a Juegos</button>
            </div>
        </div>
    `;
