# DEPLOY v195 - Historial restaurado + sab completo en editar/compartir/historial
...
foreach ($f in @('version.json', 'data_iglesia_v1.js')) {
    try {
...
Write-Host 'v195 HISTORIAL-RESTAURADO-SAB-COMPLETO DESPLEGADO'
