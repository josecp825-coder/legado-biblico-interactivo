# DEPLOY v216 - MODULO EVENTOS ESPECIALES (index.html + módulo JS + version.json)
...
foreach ($f in @('index.html', '_add_eventos_especiales.js', 'version.json')) {
    try {
...
Write-Host 'v216 EVENTOS-ESPECIALES-MODULE DESPLEGADO'
