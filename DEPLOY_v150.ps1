# DEPLOY v157 - Fix Biblia duplicados
...
foreach ($f in @('sw.js', 'version.json', 'data_iglesia_v1.js', 'himnario_data.js', 'index.html', 'data_motor.js')) {
    try {
...
Write-Host "v157 FIX-BIBLIA-DUPLICADOS DESPLEGADO"
