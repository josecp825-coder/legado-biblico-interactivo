    ...
    area.innerHTML = `
        <div style="padding:20px;max-width:700px;margin:0 auto">
            <div style="text-align:center;margin-bottom:40px">
                <h2 style="font-size:2.8rem;font-weight:900;background:linear-gradient(to right,#ff6b6b,#feca57);-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin:0">🆚 MODO VERSUS</h2>
                <p style="opacity:0.5;letter-spacing:2px;font-size:0.85rem">DESAFÍA A TUS AMIGOS EN TIEMPO REAL</p>
            </div>

            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:30px">
                <!-- CREAR SALA -->
                <div style="background:linear-gradient(135deg,rgba(255,107,107,0.15),rgba(254,202,87,0.1));border:2px solid rgba(255,107,107,0.3);border-radius:24px;padding:35px;text-align:center">
                    <div style="font-size:3rem;margin-bottom:15px">⚔️</div>
                    <h3 style="color:#ff6b6b;font-size:1.1rem;font-weight:900;margin:0 0 10px">CREAR SALA</h3>
                    <p style="opacity:0.6;font-size:0.8rem;margin-bottom:20px">Genera un código y compártelo</p>
                    <button onclick="crearSalaVersus()" id="btn-crear-sala" style="background:linear-gradient(135deg,#ff6b6b,#ee5a24);color:#fff;border:none;padding:14px 25px;border-radius:12px;font-weight:900;cursor:pointer;width:100%;font-size:0.95rem;transition:0.3s" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">CREAR ⚡</button>
                </div>

                <!-- UNIRSE A SALA -->
                <div style="background:linear-gradient(135deg,rgba(72,219,251,0.15),rgba(162,155,254,0.1));border:2px solid rgba(72,219,251,0.3);border-radius:24px;padding:35px;text-align:center">
                    <div style="font-size:3rem;margin-bottom:15px">🔗</div>
                    <h3 style="color:#48dbfb;font-size:1.1rem;font-weight:900;margin:0 0 10px">UNIRSE</h3>
                    <p style="opacity:0.6;font-size:0.8rem;margin-bottom:10px">Ingresa el código de tu rival</p>
                    <input id="input-codigo-sala" maxlength="4" placeholder="XXXX" style="width:100%;background:rgba(0,0,0,0.3);border:1px solid rgba(72,219,251,0.3);color:#fff;padding:12px;border-radius:10px;text-align:center;font-size:1.4rem;font-weight:900;letter-spacing:4px;margin-bottom:10px;box-sizing:border-box;text-transform:uppercase">
                    <button onclick="unirseSalaVersus()" style="background:linear-gradient(135deg,#48dbfb,#0abde3);color:#000;border:none;padding:14px 25px;border-radius:12px;font-weight:900;cursor:pointer;width:100%;font-size:0.95rem;transition:0.3s" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">UNIRSE 🚀</button>
                </div>
            </div>

            <!-- REGLAS DEL JUEGO -->
            <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:20px;padding:25px">
                <h4 style="color:#feca57;margin:0 0 15px;font-size:0.85rem;letter-spacing:2px">📋 CÓMO JUGAR</h4>
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:15px;text-align:center">
                    <div><div style="font-size:1.8rem;margin-bottom:5px">1️⃣</div><p style="font-size:0.8rem;opacity:0.7;margin:0">Uno crea la sala, comparte el código de 4 letras</p></div>
                    <div><div style="font-size:1.8rem;margin-bottom:5px">2️⃣</div><p style="font-size:0.8rem;opacity:0.7;margin:0">El otro jugador ingresa el código y se une</p></div>
                    <div><div style="font-size:1.8rem;margin-bottom:5px">3️⃣</div><p style="font-size:0.8rem;opacity:0.7;margin:0">¡Responde rápido! El más rápido gana los puntos de la ronda</p></div>
                </div>
            </div>

            <div style="text-align:center;margin-top:20px">
                <button onclick="renderJuegoTeens()" style="background:rgba(255,255,255,0.06);color:#fff;border:1px solid rgba(255,255,255,0.1);padding:12px 25px;border-radius:12px;cursor:pointer">← Volver</button>
            </div>
        </div>
    `;
}
