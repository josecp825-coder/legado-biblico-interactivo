# DEPLOY v108 - FIX PRESERVAR DATOS CULTOS AL ACTUALIZAR
# Archivos: index.html, legado.html, sw.js, version.json
...
foreach ($f in @('index.html', 'legado.html', 'sw.js', 'version.json')) {
    try {
...
Write-Host "v108 DESPLEGADO - Fix preservar datos cultos/liturgias"
