# DEPLOY v149 - FACHADA v2 PREMIUM (3 tarjetas + Año Bíblico)
...
foreach ($f in @('sw.js', 'version.json', 'index.html', 'data_motor.js')) {
    try {
...
Write-Host "v149 FACHADA-v2-PREMIUM DESPLEGADO"
